      ...
      <div className="grid h-full grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-3 xl:grid-rows-6">
        <div className="col-span-1 xl:row-span-3">
          <div className="grid-container">
            ...
            <div>
              <p className="grid-headtext">Hi, I&apos;m Gopal Kumar</p>
              <p className="grid-subtext">
                A passionate developer and learner focused on building modern,
                interactive web experiences with clean and efficient code.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="col-span-1 xl:row-span-3">
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-subtext">
                I work with HTML, CSS, JavaScript, Node.js, React, and Tailwind CSS — always learning and growing as a developer.
              </p>
            </div>
          </div>
        </div>
